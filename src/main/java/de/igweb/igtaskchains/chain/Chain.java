...
public class Chain {
    ...
    public static final ScheduledThreadPoolExecutor EXECUTOR = new ScheduledThreadPoolExecutor(5);
    ...
    public Chain(int period) {
        EXECUTOR.scheduleAtFixedRate(this::work, period, period, TimeUnit.MILLISECONDS);
    }
